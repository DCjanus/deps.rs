...
async fn main() {
    ...
    let server = actix_web::HttpServer::new(move || {
        actix_web::App::new()
            ...
            .service(server::crate_latest_status_feed)
            .service(server::crate_latest_status_feed_html)
            .service(server::crate_status_svg)
            .service(server::crate_status_shield_json)
            .service(server::crate_status_feed)
            .service(server::crate_status_feed_html)
            .service(server::crate_status_html)
            .service(server::repo_status_svg)
            .service(server::repo_status_shield_json)
            .service(server::repo_status_feed)
            .service(server::repo_status_feed_html)
